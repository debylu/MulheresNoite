        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>R$50,00</p>
                   <!-- Botão para acionar modal -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cabo de vela">
  Comprar
</button>
                </div>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="cabo de vela" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
